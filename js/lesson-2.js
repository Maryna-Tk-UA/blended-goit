...
// console.log(calculateAverage("Petya", "Alice"));
...
// masSum.push(arr[i] + arr[i - 1]);
// }
// return masSum;
// }

// console.log(addNum(someArr));
...
// console.log(findSmallestNumber("Alice"));
...
// for(const item of userSalaries) {
//   sum += item;
// }
// console.log(sum);
...
// const calculator = {
//   read(a, b) {
//     // Приводимо до числа і перевіряємо, чи це справжнє число
//     const numA = Number(a);
//     const numB = Number(b);
...
//       accFruit += fruit.price * fruit.quantity;
//     } 
//    }
//     return accFruit;
//   }
...
//   console.log(calcTotalPrice(fruits, "Персик"));
